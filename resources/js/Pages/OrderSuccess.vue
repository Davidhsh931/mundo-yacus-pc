            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-10">
                ...
                <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                    <div class="p-6 text-center">
                        ...
                        <!-- Icono de Éxito -->
                        <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6 border-2 border-green-200">
                            <svg class="w-8 h-8 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <!-- Detalles del Pedido -->
                        <div class="bg-amber-50 border border-amber-100 rounded-xl p-6 mb-8 text-left">
                            ...
                            <div class="bg-white p-4 rounded-lg border border-amber-100">
                                <p class="text-gray-700 mb-4 text-sm">
                                    Por favor, realiza el pago de <span class="text-lg font-medium text-amber-700">S/. {{ order.total }}</span> vía 
                                    <span class="font-medium text-gray-900 bg-amber-100 px-2 py-1 rounded text-xs">{{ order.payment_method }}</span>.
                                </p>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/orders" 
                                  class="bg-amber-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-amber-700 transition-colors flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <Link href="/" 
                                  class="text-amber-600 border border-amber-200 bg-amber-50 px-4 py-2 rounded-lg font-medium hover:bg-amber-100 transition-colors flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
