        ...
        <div class="py-10 bg-[#F8FAFC] min-h-screen">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-10">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="bg-white p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-2xl border border-gray-100 group">
                        <div class="flex items-center justify-between mb-4">
                            <span class="p-3 bg-slate-50 rounded-xl text-xl group-hover:bg-emerald-50 transition-colors">🐹</span>
                    ...
                    <div class="bg-white p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-2xl border border-gray-100 group">
                        <div class="flex items-center justify-between mb-4">
                            <span class="p-3 bg-emerald-50 rounded-xl text-emerald-600 text-xl group-hover:bg-emerald-100 transition-colors">🤖</span>
                            <button @click="ejecutarIA" class="text-gray-300 hover:text-emerald-600 transition-all hover:rotate-180 duration-500">
                        ...
                        <div class="flex items-baseline gap-2">
                            ...
                            <span class="text-[10px] px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-full font-bold">IA</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-900 p-6 shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-2xl border border-slate-800 group">
                        <div class="flex items-center justify-between mb-4">
                            <span class="p-3 bg-slate-800 rounded-xl text-emerald-400 text-xl group-hover:scale-110 transition-transform">💰</span>
                        </div>
                        ...
                        <div class="mt-2 flex items-center gap-1 text-emerald-400 text-[10px] font-bold uppercase">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                            <div class="flex justify-between items-center mb-8">
                                ...
                                <div class="flex gap-2">
                                    <span class="w-3 h-3 bg-emerald-500 rounded-full opacity-20 animate-pulse"></span>
                    ...
                    <div class="space-y-8">
                        <div class="bg-slate-900 rounded-3xl p-1 shadow-2xl shadow-emerald-900/10">
                            <div class="bg-white p-7 rounded-[calc(1.5rem-2px)] border border-slate-100">
                                <div class="flex items-center gap-3 mb-4">
                                    <div class="p-2 bg-emerald-50 rounded-lg text-emerald-600 text-xl font-bold">ML</div>
                                ...
                                <Link :href="route('ai-training.index')" class="group flex items-center justify-center gap-2 w-full bg-slate-900 text-white py-3.5 rounded-2xl font-bold text-xs hover:bg-emerald-600 transition-all duration-300 shadow-lg shadow-slate-200 hover:shadow-emerald-200">
                                    GESTIONAR CEREBRO
                                    ...
                                    <Link v-for="product in productosConLabels" 
                                        ...
                                        <div class="ml-4 flex-1 min-w-0">
                                            <div class="flex items-center gap-2 mb-1">
                                                <p class="text-sm font-bold text-slate-900 truncate group-hover:text-emerald-600 transition-colors">{{ product.name }}</p>
                                                <!-- Smart Label -->
                                                <span v-if="product.label" :class="[
                                                    'text-[9px] px-2 py-0.5 rounded-full font-bold uppercase tracking-tighter',
                                                    product.color === 'rose' ? 'bg-rose-100 text-rose-700' : 
                                                    product.color === 'amber' ? 'bg-amber-100 text-amber-700' :
                                                    product.color === 'purple' ? 'bg-purple-100 text-purple-700' :
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-[10px] text-emerald-600 font-bold">S/ {{ product.price }}</span>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
...
const analisisIA = computed(() => {
    ...
    if (props.sales < 500 && props.totalPigs > 10) {
        return {
            clase: 'border-orange-200 bg-orange-50/50',
            icon: '✅',
            ...
            btnClase: 'bg-orange-600 hover:bg-orange-700',
    ...
    return {
        clase: 'border-emerald-200 bg-emerald-50/50',
        icon: '✅',
        ...
        btnClase: 'bg-slate-900 hover:bg-emerald-600',
