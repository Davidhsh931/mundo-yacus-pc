            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-10">
                ...
                <div v-if="orders && orders.length > 0" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div v-for="order in orders" :key="order.id" 
                        ...
                        <!-- Order header -->
                        <div class="relative bg-gradient-to-r from-amber-50 to-orange-50 p-6 border-b border-gray-100">
                            <div class="flex justify-between items-start gap-4">
                                <div>
                                    <div class="flex items-center gap-2 mb-2">
                                        <span class="text-2xl">**</span>
                                        <span class="text-xs font-medium text-amber-700 uppercase tracking-wide">Orden #{{ order.id }}</span>
                                    </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div v-for="item in order.items" :key="item.id" 
                                     class="flex items-center gap-4 p-3 bg-gray-50 rounded-xl hover:bg-amber-50 transition-colors">
                        ...
                        <div class="bg-gray-50 p-4 flex justify-between items-center border-t border-gray-100">
                            ...
                            <div class="flex gap-2">
                                <Link :href="`/orders/${order.id}`" 
                                      class="px-4 py-2 bg-amber-600 text-white text-xs font-medium hover:bg-amber-700 transition-colors rounded-lg flex items-center gap-1">
                ...
                <div v-else class="bg-white border border-gray-100 rounded-2xl py-16 text-center">
                    <div class="w-20 h-20 bg-amber-50 rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-10 h-10 text-amber-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <Link href="/" class="inline-flex items-center gap-2 px-4 py-2 bg-amber-600 text-white text-sm font-medium hover:bg-amber-700 transition-colors rounded-lg">
